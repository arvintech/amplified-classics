  ...
  termsToKnow: [
    {
      ...
      whyItMatters: 'Marrying for money was common in Regency England where financial security was crucial and women\'s limited earning capacity made wealth a practical consideration. However, even in that context, Willoughby\'s behavior is condemned because he pursued Marianne\'s affections intensely while knowing he would ultimately marry for money, creating suffering through deception. Modern parallels: people who date for love while planning to "marry up" financially; individuals who pursue genuine romantic connections while maintaining different relationship for economic benefit; partners who leave relationships for wealthier prospects. Understanding this helps recognize when financial considerations appropriate (practical compatibility) versus when they constitute manipulation (using people emotionally while planning to leave for money).'
    },
    {
      ...
      whyItMatters: 'Retroactive betrayal is particularly devastating because it damages not just present and future but also past. You lose both the relationship and your positive memories of it. Modern applications: discovering partner was cheating during period you thought relationship was at its best; learning someone pursued you strategically while being committed elsewhere; finding that person you trusted was manipulating situation throughout. This requires painful mental work of reviewing entire relationship history, reframing every interaction, and grieving both what you thought you had and what actually occurred. Protection: recognize that discovering betrayal doesn\'t mean your experience wasn\'t real—your feelings were genuine even if partner\'s weren\'t, and joy you felt in moments was valid even if founded on incomplete information.'
    },
    {
      ...
      whyItMatters: 'Understanding this transition helps recognize that confirmed loss, while painful, often enables better processing than ongoing uncertainty. When hoping, you cannot fully grieve because situation might still change; when certain, grief is clear and unambiguous. Modern applications: waiting for ex to return versus learning they\'re in new relationship; hoping job offer might still come versus receiving definite rejection; maintaining hope about situation versus getting clear answer. While hope feels better than certainty of loss, prolonged uncertainty often creates worse outcomes than clear knowledge, even when knowledge confirms feared outcome. Sometimes closure, even painful closure, serves better than sustained ambiguity.'
    },
    {
      ...
      whyItMatters: 'Mercenary romance uses romantic behavior to serve self-interest while concealing true intentions. Modern examples: people who date seriously while actually seeking financial support; individuals who pursue romantic connections for ego boost, sexual access, or social standing without genuine commitment intentions; partners who maintain relationships for benefits (housing, status, companionship) while planning to leave when better opportunity arises. Red flags: partner\'s behavior changes when learning about your financial status; relationship progresses differently than partner\'s stated long-term plans; person shows more interest in what you provide than who you are. Protection: pay attention to whether partner\'s actions align with words, notice if relationship benefits them disproportionately, and recognize that genuine love considers both parties\' wellbeing rather than serving primarily one person\'s interests.'
    },
    {
      ...
      whyItMatters: 'Losing to a wealthy rival creates unique pain because it suggests your personal qualities were insufficient to overcome economic considerations. Modern applications: partner leaving for someone wealthier; being passed over professionally for candidate with more resources; losing opportunities to competitors with financial advantages. This raises questions about what truly matters in relationships and whether love should overcome economic considerations. While financial compatibility is legitimate concern, choosing wealth over genuine connection suggests valuing money more than personal qualities. For those experiencing this: recognize that being left for money reflects partner\'s priorities and limitations, not your inadequacy. Someone choosing wealth over you reveals they prioritize financial security over qualities you offer, which may indicate you\'re incompatible in values regardless of finances.'
    },
    {
      ...
      whyItMatters: 'Sensibility\'s emphasis on authentic feeling and instinctive judgment creates beautiful experiences when feelings prove reliable but catastrophic vulnerability when they mislead. Modern parallels: people who "love with their whole heart" experiencing complete devastation when relationships fail; individuals whose romantic philosophy rejects caution as cynical facing betrayal without emotional protection; those who trust intense feelings over careful evaluation discovering their judgments were wrong. This doesn\'t mean sensibility is wrong—its capacity for deep feeling creates profound connections. But it suggests need for balance: maintaining capacity for intense feeling while developing some evaluation skills and emotional resilience. Pure sensibility without any sense creates unsustainable vulnerability; pure sense without any sensibility creates emotionally impoverished life. Ideal integrates both: deep feeling with wise judgment, passionate attachment with realistic assessment.'
    }
  ],
