...
export const chapter18: ChapterData = {
  ...
  summary: {
    ...
    full: [
      ...
      'Chapter 18 completes the test of sensibility begun in Chapter 17—Willoughby\'s engagement confirms that Marianne\'s passionate certainty was based on misinterpretation. His behavior suggested commitment his intentions never included. She must confront that sensibility\'s trust in feeling, dismissal of warnings, and assumption that intensity indicated genuine love all failed to protect her. The revelation demonstrates the cost of romantic philosophy that valorizes passion over evaluation: she invested totally based on emotional conviction while he calculated financially, leaving her devastated while he pursues advantage.'
    ]
  },
...
The question isn\'t whether to love deeply—that creates life\'s most meaningful experiences. The question is how to love deeply while developing resilience that enables survival when love fails, integration that allows profound feeling with wise judgment, and balance that permits intensity without creating complete vulnerability to circumstances beyond your control.`
    ...
    {
      id: 'marrying-for-money-exploitation',
      title: 'Love vs. Financial Calculation: When Willoughby Courted for Pleasure While Planning to Marry for Money',
      question: 'Did Willoughby cynically manipulate Marianne while always planning to marry wealth? What makes this particularly cruel?',
      aiResponse: `Willoughby\'s engagement to Miss Grey—a woman of considerable fortune—reveals he prioritized financial advantage over romantic attachment to Marianne. His behavior suggests he either courted Marianne cynically (always intending to marry wealth) or indulged genuine feeling he knew couldn\'t culminate in marriage given financial needs. Either interpretation reveals character willing to sacrifice love for money while treating Marianne\'s emotions as disposable. This is particularly cruel because: he created intense expectations through intimate behavior while never intending commitment, enjoyed romantic connection while planning to leave for wealth, and damaged Marianne emotionally for his pleasure or indecision. Modern parallels: dating for love while planning to "marry up" financially, leaving relationships for wealthier prospects, or maintaining relationships as placeholders while seeking financial advantages. Protection: have explicit conversations about life priorities and values early, recognize that someone who prioritizes money over connection in marriage will prioritize it in other contexts, and understand that actions matter but without words confirming intentions about shared future, they create dangerous assumptions. Legitimate financial considerations differ from exploiting people emotionally while planning to leave for money.`
    },
    {
      id: 'retroactive-betrayal-memories',
      title: 'Poisoned Past: How Betrayal Damages Not Just Future But Also Cherished Memories',
      question: 'How does learning of Willoughby\'s engagement force Marianne to reinterpret their entire relationship? Why does this hurt beyond losing future?',
      aiResponse: `Learning of Willoughby\'s engagement forces Marianne to retroactively reinterpret their entire relationship. Every intimate conversation, romantic gesture, moment of apparent mutual understanding must now be understood as occurring while he either intended to marry someone else or was undecided between love and money. This transforms cherished memories into painful evidence of betrayal—not because moments weren\'t enjoyable when experienced but because they were built on false foundation of assumed mutual commitment and honest intentions. This damages not just present and future but also past—you lose both the relationship AND your positive memories of it. Modern examples: discovering partner was cheating during relationship\'s best period, learning someone pursued you strategically while committed elsewhere, finding out "perfect" moments were performed despite hidden agendas. The pain: your feelings were genuine even if partner\'s weren\'t; joy you felt was valid even if founded on incomplete information; but memories you treasured now cause pain rather than comfort. You must grieve not just lost future but also betrayed past, reframing entire relationship through lens of revealed deception. Some memories remain genuinely positive despite betrayal; others become too painful to recall. The challenge is integrating reality of betrayal with validity of your own experience and feelings.`
    },
    {
      id: 'hope-to-certainty-grief-stages',
      title: 'From Torturous Hope to Painful Certainty: Why Confirmed Loss, Though Devastating, Enables Healing',
      question: 'Why does Willoughby\'s engagement, though devastating, create different grief than his departure\'s uncertainty? Is painful certainty better than torturous hope?',
      aiResponse: `Willoughby\'s departure (Chapter 17) created agonizing uncertainty—Marianne could hope complications would resolve and he would return, preventing full grief processing. His engagement (Chapter 18) eliminates that hope definitively, transitioning from uncertain to certain loss. This involves distinct grief stages: Uncertainty creates anxiety, suspended processing, inability to move forward (can\'t grieve what might not be lost), constant emotional whiplash between hope and despair. Certainty enables actual grief process—acknowledging loss, processing emotions, beginning healing—and brings relief from exhausting hope. While painful, confirmed loss often serves better than sustained ambiguity because: you can stop waiting and start accepting, begin actual healing rather than remaining in limbo, redirect emotional energy from hoping to processing, and make decisions based on reality rather than possibility. Modern examples: waiting for ex to return versus learning they\'re in new relationship; hoping for job offer versus receiving definite rejection; wondering if relationship might resume versus knowing definitively it won\'t. Sometimes painful closure serves better than sustained ambiguity. However, certainty\'s grief is real—knowing definitively that relationship is lost, that person chose someone else, and that hoped-for future won\'t happen. Marianne must grieve not just lost future but also betrayed past, requiring reinterpreting entire relationship through lens of his ultimate choice to marry for money rather than love.`
    }
  ],
