...
export const chapter1: ChapterData = {
  number: 1,
  title: 'A Guardian\'s Anxious Letter',
  ...
  // ===================================================================
  // MODERN ADAPTATION
  // Contemporary parallels and connections
  // ===================================================================
  modernAdaptation: {
  ...
  // ===================================================================
  // THEMATIC THREADS
  // Recurring themes that thread through the narrative
  // ===================================================================
  thematicThreads: [
    {
      emoji: '🎭',
      name: 'Social Codes Enforced But Untaught',
    ...
    {
      emoji: '👨‍👧',
      name: 'Identity Depends on Paternal Recognition',
    ...
    {
      emoji: '🛡️',
      name: 'Protective Love Versus Worldly Preparation',
    ...
    {
      emoji: '✉️',
      name: 'Epistolary Performance for Audience',
...
- What does this opening reveal about 18th-century readers' expectations and concerns?`
  ...
  // ===================================================================
  // EDUCATOR RESOURCES
  // Practical classroom tools and activities
  // ===================================================================
  educatorResources: {
    writingPrompt: {
