  ...
  parts: [
    ...
    },
    {
      ...
      chapters: [
        ...
        { number: 20, description: 'In the days following Mason\'s attack, the house party dissolves and Jane processes the disturbing events—then receives urgent summons from Gateshead: Mrs. Reed is dying and has asked to see Jane.' },
